      ...
      <div className="p-10  h-screen bg-gradient-to-br from-white to-slate-400">
        ...
        >
          <input
            ...
            // className={errors ? "border-red border-1" : ""}
            // className="w-full shadow appearance-none border border-black rounded   py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
            type="text"
