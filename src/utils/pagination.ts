...
export const setArray = (
  ...
  const totalPageCount = Math.ceil(pagination.total / pagination.pageSize);

  // Pages count is determined as siblingCount + firstPage + lastPage + pagination.page + 2*DOTS
